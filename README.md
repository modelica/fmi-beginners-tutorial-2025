...
2. Validate and simulate FMUs with fmusim
3. work with FMUs in FMPy
  ...
  12. generate a Jupyter notebook from the FMU and run it


## Part 3: Connecting and simulating Multiple FMUs (40 min)
...
1. Create a Container FMU with fmpy
2. Simulate the container FMU in fmpy or fmusim
